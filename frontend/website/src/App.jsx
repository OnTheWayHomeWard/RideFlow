...
function Header({ settings, bookUrl, brandName }) {
  ...
  return (
    <header className={`fixed top-0 left-0 right-0 z-30 px-5 transition-all duration-300 ${
      scrolled ? 'py-3 bg-[var(--emerald-deep)]/85 backdrop-blur-lg border-b border-white/10' : 'py-5'
    }`}>
    ...
    <footer className="bg-[var(--emerald-deep)] text-white/70 px-5 py-10 relative overflow-hidden">
      ...
      <div className="relative max-w-6xl mx-auto">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-8">
          ...
          <div>
            <p className="text-xs uppercase tracking-wider text-white/40 mb-2 font-semibold">Quick links</p>
            <div className="space-y-1.5 text-sm">
              ...
              <a href="#contact" className="block hover:text-[var(--gold)] transition-colors">Contact us</a>
          ...
          <div>
            ...
            <div className="space-y-1.5 text-sm">
              ...
              {settings.company_email && <a href={`mailto:${settings.company_email}`} className="block hover:text-[var(--gold)]">{settings.company_email}</a>}
            </div>
          </div>
        </div>
        <div className="border-t border-white/10 pt-5 text-xs flex flex-col sm:flex-row items-center justify-between gap-3">
          ...
          <span className="text-white/40">Made with care.</span>
        </div>
      </div>
    </footer>
  )
