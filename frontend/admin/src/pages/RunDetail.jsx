...
export default function RunDetail() {
  ...
  useEffect(() => { api.getBookingDetail(bookingId).then(setRun).catch(() => {}).finally(() => setLoading(false)) }, [bookingId])
  ...
  return (
    <div className="p-4 lg:p-6">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-4 mb-5">
        ...
        {/* Driver */}
        <div className="bg-white border border-slate-200 rounded-xl p-4">
          <h3 className="text-xs text-slate-400 uppercase tracking-wide font-medium mb-2">Driver</h3>
          {run.driver ? (
            <>
