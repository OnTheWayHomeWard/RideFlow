...
const NAV = [
  ...
  // Notifications intentionally NOT in the sidebar — the bell in the top bar
  // opens the same inbox as a dropdown. Keeping /admin/notifications as a
  // route (see AdminApp.jsx) so any old bookmark or FCM deep-link still lands.
