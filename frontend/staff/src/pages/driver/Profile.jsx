  ...
  return (
    <div className="p-4 pb-20">
      ...
      <div className="space-y-2 mt-4">
        ...
        {/* Sign Out — moved off the header into Profile. Confirm before wiping
            so a mid-shift tap doesn't drop the driver off the app. */}
        <button
          type="button"
          onClick={() => {
            if (!window.confirm('Sign out of the driver app?')) return
