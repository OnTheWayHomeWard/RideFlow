...
export default function RunDetail() {
  ...
  return (
    <div className="p-4 lg:p-6">
      <Link to="/admin/runs" className="inline-flex items-center gap-1 text-sm text-slate-500 hover:text-slate-700 mb-4">
        ...
        <div className="bg-white border border-slate-200 rounded-xl p-4">
          ...
          {run.driver ? (
            <>
              ...
              <Link to={`/admin/drivers/${run.driver.id}`} className="text-xs text-blue-600 mt-1 inline-block">View driver profile</Link>
            </>
