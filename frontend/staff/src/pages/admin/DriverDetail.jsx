...
export default function DriverDetail() {
  ...
  return (
    <div className="p-4 lg:p-6">
      <Link to="/admin/drivers" className="inline-flex items-center gap-1 text-sm text-slate-500 hover:text-slate-700 mb-4">
        ...
        <div className="flex items-start gap-3 mb-4">
          ...
          <div className="flex gap-2 shrink-0">
            ...
            <button onClick={async () => {
              ...
              try { await api.deleteDriver(driverId, true); navigate('/admin/drivers') } catch (e) { alert(e.message) }
