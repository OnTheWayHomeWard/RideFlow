  ...
  return (
    <div className="p-4">
      ...
      <div className="space-y-3">
        <Link to="/cashier/book-for-guest" className="block bg-purple-600 text-white rounded-xl p-4 hover:bg-purple-700 transition-all">
        ...
        <Link to="/cashier/qr" className="block bg-white border border-purple-200 text-purple-700 rounded-xl p-4 hover:bg-purple-50 transition-all">
          <div className="flex items-center gap-3">
            <svg className="w-8 h-8" fill="none" stroke="currentColor" viewBox="0 0 24 24">
        ...
        <Link to="/cashier/referrals" className="block bg-white border border-slate-200 rounded-xl p-4 hover:border-purple-300 transition-all">
          <div className="flex items-center gap-3">
      ...
      <div className="mt-6 bg-white border border-slate-200 rounded-xl p-4">
        ...
        <Link to="/cashier/change-password" className="mt-3 flex items-center justify-between p-3 bg-slate-50 rounded-lg hover:bg-slate-100 transition-colors">
